...
without misrepresenting the selected verifier. The distinction among `VERIFIED`, `FAILED`,
`UNSUPPORTED`, and `ERROR` must remain explicit.

### Portability and testing

Useful work includes exercising supported Python, Java/Nagini, Lean, and platform
combinations; reproducing and documenting verifier environment issues;
...
deterministic human rendering, deterministic verifier lowering, and human
...
daemon, service, plugin layer, persistent JVM, Lean process, or other architecture without
